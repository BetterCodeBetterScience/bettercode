...
plt.tight_layout()
plt.savefig(FIGURE_DIR / 'pytorch_gpu_acceleration_summary.png', dpi=300)
#plt.show()
...
if gpu_history and gpu_optimized_history:
    ...
    plt.tight_layout()
    #plt.show()
    plt.savefig(FIGURE_DIR / 'pytorch_gpu_acceleration_comparison.png', dpi=300)
...
if gpu_device is not None:
    ...
    plt.tight_layout()
    plt.savefig(FIGURE_DIR / 'pytorch_gpu_batch_size_benchmark.png', dpi=300)
    #plt.show()
